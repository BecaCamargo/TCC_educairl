    ...
    <div class="container">
        <div class="content first-content">
            ...
            <div class="second-column">
                ...
                <form class="form">
                    ...
                    <button onclick="verificar()" class="btn btn-second">Registrar-se</button>        
                </form>
            </div><!-- second column -->
        </div><!-- first content -->
        <div class="content second-content">
            <div class="first-column">
                ...
                <p class="description description-primary">insiras seus dados pessoais</p>
                <p class="description description-primary">e comece sua jornada conosco</p>
                <button id="signup" class="btn btn-primary">inscrever-se
                </button>
            </div>
            <div class="second-column">
                <h2 class="title title-second">Entrar no nosso site</h2>
                <div class="social-media">
                    <ul class="list-social-media">
                        <a class="link-social-media" href="#">
                            <li class="item-social-media">
                ...
                <form class="form">
                    ...
                    <button class="btn btn-second" onclick="verificar2()">Registrar-se</button>
                </form>
            </div><!-- second column -->
        </div><!-- second-content -->
    </div>
